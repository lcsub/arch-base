...
pacman -Sy
pacman -S --noconfirm efibootmgr grub xf86-video-amdgpu xorg-server os-prober firefox steam networkmanager alacritty gnome-shell gnome-control-center nautilus gdm gnome-tweak-tool rsync pcsx2
...
mount /home
mkdir /home/lcsub
cp /home/scripts/.alacritty.yml /home/lcsub/
